...
|  +----------+           +----------+      |
|                                           |
|  Tab/Q to toggle       Current: CAPTURE   |
|                                           |
+-------------------------------------------+
```
...
|                                           |
|  +---------------------------------+      |
|  | ! INVENTORY FULL - AUTO DESTROY |      |
|  +---------------------------------+      |
|                                           |
|  Switching to DESTROY mode                |
|  Discard enemies to re-enable CAPTURE     |
|                                           |
+-------------------------------------------+
```

### Enemy Inventory Screen
```
+---------------------------------------------------+
|                                                   |
|  ENEMY INVENTORY (12/25)            [X] CLOSE     |
|                                                   |
|  +------+ +------+ +------+ +------+ +------+     |
|  |SCRUB1| |SCRUB2| |TANK1 | |ZIPPER| |SCRUB3|     |
|  | Lv.2 | | Lv.1 | | Lv.3 | | Lv.2 | | Lv.1 |     |
|  |      | |      | |      | |      | |      |     |
|  +------+ +------+ +------+ +------+ +------+     |
|                                                   |
|  +------+ +------+ +------+ +------+ +------+     |
|  |ZIPPER| |TANK2 | |BOSS1 | |SCRUB4| |TANK3 |     |
|  | Lv.1 | | Lv.2 | | Lv.4 | | Lv.2 | | Lv.1 |     |
|  |      | |      | |      | |      | |      |     |
|  +------+ +------+ +------+ +------+ +------+     |
|                                                   |
|  +------+ +------+                                |
